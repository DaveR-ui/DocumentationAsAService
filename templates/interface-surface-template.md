...
[../guidelines/04-validation.md](../guidelines/04-validation.md)). The body shape below is a
contracted exception under [02 §2](../guidelines/02-document-contract.md) — registered doc classes
keep their documented anatomy — while the frontmatter contract is unchanged. The rationale for one
class instead of two lives in ADR-0002; link it, don't restate it.
