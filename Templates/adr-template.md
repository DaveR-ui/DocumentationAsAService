...
folder anatomy, the generated-artifact pipeline, or the version-bump policy — see
[../guidelines/03-lifecycle-and-generated-files.md](../guidelines/03-lifecycle-and-generated-files.md)
§4, where a contract-breaking (MAJOR) bump *requires* an ADR.
